...
const howItWorks = [
  { step: "Sign Up", description: "Create your free BookEase account" },
  {
    ...
    <main className="container mx-auto px-4 py-16">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-12 mb-24">
        <div className="lg:w-1/2">
          ...
          <p className="text-xl text-gray-600 mb-10">
            BookEase helps you manage your time effectively. Create events, set
            your availability and let others book time with you seamlessly.
          </p>
          <Link href={"/dashboard"}>
            <Button size="lg" className="text-lg gradient-bg">
          ...
          {howItWorks.map((step, index) => (
            <div key={index} className="text-center">
              <div className="bg-black-100 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                <span className="text-black font-bold text-xl border-black border-2 rounded-full w-10 h-10 flex items-center justify-center">
                  {index + 1}
                </span>
              </div>
      ...
      <div className="gradient-bg text-white rounded-lg p-8 text-center">
        ...
        <p className="text-xl mb-6">
          Join thousands of professionals who trust BookEase for efficient time
          management.
        </p>
        <Link href={"/dashboard"}>
